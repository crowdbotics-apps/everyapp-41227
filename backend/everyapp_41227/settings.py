"""
Django settings for everyapp_41227 project.
...
ROOT_URLCONF = 'everyapp_41227.urls'
...
WSGI_APPLICATION = 'everyapp_41227.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "everyapp_41227 API",
    "DESCRIPTION": "API documentation for everyapp_41227 App",
    "VERSION": "v1",
}
